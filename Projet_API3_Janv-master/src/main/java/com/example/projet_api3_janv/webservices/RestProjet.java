...
public class RestProjet {
    ...
    public ResponseEntity<List<APIProjet>> listAPIProjetNomproj(@PathVariable(value="nomproj") String nomproj) throws Exception{
        System.out.println("recherche de "+nomproj);
        List<APIProjet> projet;
        projet = projetServiceImpl.readNom(nomproj);
        return new ResponseEntity<>(projet, HttpStatus.OK);
    }
    /*-------------------Retrouver le projet portant un nom donné--------------------------------------------------------
    @RequestMapping(value = "/cout={cout}", method = RequestMethod.GET)
    public ResponseEntity<List<APIProjet>> listAPIProjetCout(@PathVariable(value="cout") Double cout) throws Exception{
        System.out.println("recherche de projet égale ou sup à "+cout);
        List<APIProjet> projet;
        projet = projetServiceImpl.readCout(cout);
        return new ResponseEntity<>(projet, HttpStatus.OK);
    }
    */
    ...
    public ResponseEntity<APIProjet> createAPIProjet(@RequestBody APIProjet prj) throws Exception {
        System.out.println("Création du projet géré par " + prj.getIdresponsable());
    ...
    public ResponseEntity<List<APIProjet>> listAPIProjet() throws Exception{
        ...
        return new ResponseEntity<>(projetServiceImpl.getProjets(), HttpStatus.OK);
    }
