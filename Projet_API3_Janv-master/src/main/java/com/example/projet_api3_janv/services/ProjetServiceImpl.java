...
public class ProjetServiceImpl implements InterfProjetService{
    ...
    public List<APIProjet> readNom(String nomproj) throws Exception {
        return projetRepository.findByNomprojLike(nomproj+"%");
    }

    /*public List<APIProjet> readCout(Double cout) throws Exception {
        return projetRepository.findByCout(cout);
    }*/
    ...
    public List<APIProjet> getProjets() {
        List<APIProjet> lprj = projetRepository.findAll();
        return lprj;
    }
}
